...
export default class Profile extends React.Component {
    ...
    editProfile() {
        this.setState({ changeName: true, changeAge: true, isEdit: true });
        setTimeout(() => {
    ...
    saveProfile() {
        this.setState({ changeName: false, changeAge: false, isEdit: true, webViewLoading: true });
        const { setParams } = this.props.navigation;
    ...
    render(style = {
        ...
        return (
            <View style={{
                ...
                <View style={{ width: "80%", justifyContent: "center", alignSelf: "flex-start" }}>

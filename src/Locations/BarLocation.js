...
class BarLocation extends React.Component {
    ...
    static enableGPS(fnCallback: Function) {
        ...
        return {
            ...
            headerLeft: (
                <TouchableOpacity onPress={() => {
                    this.enableGPS(() => {
                        navigation.navigate("BobLocationsAll", { screen: "BobLocationsAll" });
                    });
                }}
    ...
    componentDidUpdate(prevProps) {
        ...
        if (prevProps.isFocused !== this.props.isFocused) {
            if (this.props.isFocused) {
                console.log("didupdate", this.params.barId);
            ...
            fetch(GlobalVariables._URL + "/vendors/" + idBar + "/" + GlobalVariables.userLanguage.value + "/" + lat + "/" + long, {
                ...
                .then(response => {
                    if (response !== "") {
                        ...
                        this.setState({ numberStars: response.ra, barData: DataItem, workingHours: hourItem, distance: curr_distance });
            ...
            <View style={{ flex: 1 }}>
                ...
                <ScrollView style={{ flex: 1 }}>
                    <View style={{ marginLeft: 10, marginRight: 10, marginTop: 10 }}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: 15 }}>
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity style={{
                                    ...
                                    if (session.value === "true" && GlobalVariables.restId.value.toString() === this.params.barId.toString()) {
                                        ...
                                        AsyncStorage.getItem('checkIn').then((checkedIn) => {
                                            if (session.value == "false") {
                                                ...
                                                GlobalVariables.restId.value = this.state.barData.id;
                                    ...
                                    <Image source={require("../../res/images/menu-bg.png")} style={{ width: 50, height: 50, resizeMode: "contain" }} />
                                    <Text style={{
                                        color: "white",
                                        fontFamily: "Helvetica",
                                        fontSize: 14,
                        ...
                        <View style={{ flexDirection: "column", justifyContent: "flex-start", width: "90%" }}>
                            ...
                            {GlobalVariables.userLanguage.value === "he-IL" ?
                                <Text style={{
                                    ...
                                    marginTop: 8,
                                    textAlign: "left"
                                }}>{this.state.barData.phone != 'null' ? this.state.barData.phone : ''}</Text> :
                                <Text style={{ color: "#9b9b9b", marginTop: 8 }}>{this.state.barData.phone != 'null' ? this.state.barData.phone : ''}</Text>}
                            {GlobalVariables.userLanguage.value === "he-IL" ?
                                <Text style={{
                                    color: "#9b9b9b",
                                    marginTop: 8,
                                    textAlign: "left"
                                }}>{this.state.barData.website != 'null' ? this.state.barData.website : ''}</Text> :
                                <Text style={{ color: "#9b9b9b", marginTop: 8 }}>{this.state.barData.website != 'null' ? this.state.barData.website : ''}</Text>}
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    AsyncStorage.getItem('savedBarId').then((savedBarId) => {
                                        if (session.value === "false") {
                                        ...
                                        } else if (savedBarId == this.params.barId && this.state.isCheckIn) {
                                            this.manualCheckOut()
                                            ...
                                            if (GlobalVariables.TEST_CHECK_IN_ENABLED) {
                                                locationCheckoutCondition = (this.state.barData.distance < 0.5);
                                            }
            ...
            fetch(GlobalVariables._URL + "/checkin", {
                ...
                .then(response => {
                    ...
                    if (response !== null) {
                        ...
                        AsyncStorage.setItem('locationDiscount', response.discountPercentage);
    ...
    render() {
        ...
        return (
            <View style={{ flex: 1, height: "100%", width: "100%", flexDirection: "column" }}>
                ...
                <Modal transparent={true} isVisible={this.state.IsModalVisibleTableNumber}>
                        ...
                        <View style={styles.barModalView}>
                            <View style={PageStyles.modalSecondView}>
                                ...
                                <View style={PageStyles.container}>
                                    <TouchableOpacity style={styles.padCenterText}
                                    ...
                                    />
                                    <TouchableOpacity style={styles.padCenterText} onPress={() => {
                            ...
                            <View style={PageStyles.modalSecondView}>
                                ...
                                <View style={PageStyles.container}>
                                    <TouchableOpacity style={styles.padCenterText}
                                        ...
                                        <Text style={PageStyles.textStyle}>{localeStrings.barLocationStrings.later}</Text>
                                    </TouchableOpacity>
                                    <View
                                        style={{
                                            borderLeftWidth: 1,
                                    ...
                                    <TouchableOpacity style={styles.padCenterText}
                                        ...
                                        <Text style={PageStyles.textStyle}>{localeStrings.barLocationStrings.checkIn}</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        </View>

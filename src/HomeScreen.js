...
class HomeScreen extends React.Component {
    onShare = async () => {
        try {
            if (session.value === "true") {
                message = this.state.userName + localeStrings.homeScreenStrings.shareMessageLoggeedIn + '\n';
            } else {
                ...
                if (checkedInLocationLat && checkedInLocationLng) {
                    if (this.state.isCheckIn === true) {
                        Geolocation.getCurrentPosition((position) => {
                            ...
                            let distFromRestaurant = getPreciseDistance(startCoords, endCoords);
                            if (distFromRestaurant > GlobalVariables.DISTANCE_FROM_CHECKED_IN_LOCATION) {
                                this.checkOut();
                            }
                        }, (error) => {
                            console.log(error)
                ...
                .then(response => {
                    ...
                    if (response !== null) {
                        if (response.vendorId === 0) {
                            ...
                            AsyncStorage.setItem("LocationDiscountPercent", response.discountPercentage);
                            ...
                            this.watchID = Geolocation.watchPosition(
                                position => {
                                    ...
                                    if (this.state.showAlert) {
                                        if (parseFloat(this.state.distanceTravelled).toFixed(2) === 0.00) {
                                            this.checkOut();
                                        }
                                    }
                                },
                ...
                if (value === "true") {
                    AsyncStorage.getItem('userId').then((value) => {
                        ...
                        if (value !== null && value !== "") {
                            ...
                            if (isNaN(GlobalVariables.userId.value)) {
                                GlobalVariables.userId.value = GlobalVariables.userId.value.replace(/['"]+/g, '')
                            }
                            ...
                            .then(async base64Data => {
                                if (base64Data) {
                                    this.setState({
                                        ...
                                        image: {
                                            uri: thumbnailImage,
                                            base64Uri: `data:application/octet-stream;base64,` + base64Data
                                        }
                                    });
                                } else {
                                    this.setState({
                    ...
                    Geolocation.getCurrentPosition((position) => {
                        ...
                        var a = 'You are ' +
                            getDistance(position.coords, {
                                latitude: this.state.checkedInLocationLat,
                                longitude: this.state.checkedInLocationLong,
                            }) + ' meters away from Checked In Location : ' + this.state.checkedInLocationLat + ' , ' + this.state.checkedInLocationLong;
                        console.log(GlobalVariables._DISTANCE_FROM_CHECKEDINLOCATION)
                        console.log(a)
                        if (getDistance(position.coords, {
                            latitude: this.state.checkedInLocationLat,
                            longitude: this.state.checkedInLocationLong,
                        }) > GlobalVariables._DISTANCE_FROM_CHECKEDINLOCATION) {
                            this.checkOut()
    ...
    componentDidMount() {
        ...
        AsyncStorage.getItem('checkedInLocationLat').then((value) => {
            this.setState({ checkedInLocationLat: value })
        }).done();
        AsyncStorage.getItem('checkedInLocationLong').then((value) => {
    ...
    render() {
        ...
        return (
            ...
            <View style={{ height: "100%", flexDirection: "column", justifyContent: "space-between" }}>
                ...
                {/*<View style={{height: height * 0.44, marginLeft: 8}}>*/}
                ...
                {/*            <View style={{width: width / 1.6, height: height * 0.30, marginRight: 8}} key={index}>*/}
                {/*                <ImageLoad style={{*/}
                {/*                    resizeMode: 'contain',*/}
                {/*                    width: width / 1.6,*/}
                {/*                    height: height * 0.48*/}
                        ...
                        <TouchableOpacity style={styles.cardTouchableOpacity}>
                            <View style={styles.imageShadowView}>
                                <View style={styles.couponMainImgShadow}>
                                    <View>
                                        <Image
                                            source={require("../res/images/drinks.png")}
                ...
                <View style={{ margin: 7 }}><Text style={{ color: "gray", fontWeight: "bold" }}>{localeStrings.homeScreenStrings.bestOffer}</Text></View>
                {/*For Second Scroll */}
                <View style={{ flexDirection: 'row', width: '100%' }}>
                    <ScrollView
                        horizontal={true}
                        ...
                        <TouchableOpacity style={styles.cardTouchableOpacity}>
                            <View style={styles.imageShadowView}>
                                <View style={styles.couponMainImgShadow}>
                                    <View>
                                        <Image
                                            source={require("../res/images/salad-1.png")}
                                            style={styles.couponMainImg}
                                        />
                                    </View>
                                    <View
                                        ...
                                        <Image
                                            style={styles.footerImage}
                                            source={require("../res/images/cosmobar.png")}
                                        />
                                    </View>
                                </View>
                            </View>
                            ...
                            <TouchableOpacity style={styles.QuickMenuButton}
                                onPress={() => {
                                    ...
                                    this.handleNavigation("MenuSlider", {
                                        ...
                                        tableNumber: GlobalVariables.tableNumber.value ? GlobalVariables.tableNumber.value : this.state.tableNumber,
                                        showWelcome: false
                                    })
                                }}>
                                <Text
                                    style={styles.QuickBtnTextStyle}>{localeStrings.homeScreenStrings.quickMenu}</Text>
                            </TouchableOpacity>
                ...
                <View style={{
                    ...
                    <View style={{ flex: 1 }}>
                        {this.state.isCheckIn ?
                            <TouchableOpacity onPress={() => {
                                ...
                                <ImageBackground style={styles.currentLocationPopUp}
                                    source={I18nManager.isRTL ? require("../res/images/pop-bg1.png") : require("../res/images/pop-bg.png")}>
                                    <Text style={{
                                        fontWeight: 'bold',
                                        color: "white",
                                        textAlign: "center",
                                        ...
                                        flex: 1,
                                        flexWrap: 'wrap',
                                    }}>{localeStrings.homeScreenStrings.currentLocation} </Text>
                                </ImageBackground>

                            </TouchableOpacity> : null}
                        <TouchableOpacity onPress={() => {
                            this.enableGPS();
                            this.handleNavigation("BobLocationsAll", { screen: "BobLocationsAll" });
                        }}
                            style={{ flex: 1, justifyContent: "center" }}>
                            {(this.state.isCheckIn) ? <ImageBackground style={styles.ImgBackgroundCheckin}
                                source={require("../res/images/locations-bg.png")}>
                                <Text style={styles.TextImgCheckin}>{localeStrings.homeScreenStrings.locations}</Text>
                            </ImageBackground> : <ImageBackground style={styles.ImgBackground}
                                source={require("../res/images/locations-bg.png")}>
                    ...
                    <View style={{ flex: 1, marginRight: 0, marginLeft: 0, width: width - 30, flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
                        <TouchableOpacity onPress={() => {
                            ...
                            {(this.state.isCheckIn) ? <ImageBackground style={styles.ImgBackgroundCheckin}
                                ...
                                <Text style={styles.TextImgCheckin}>{localeStrings.homeScreenStrings.checkIn}</Text>
                            </ImageBackground> : <ImageBackground style={styles.ImgBackground}
                                source={require("../res/images/scan-bg.png")}>
                    ...
                    <View style={{ flex: 1, width: width - 30 }}>
                        {(this.state.gotOrder && (this.state.isCheckIn)) ?
                            <TouchableOpacity onPress={() => {
                                ...
                                <ImageBackground style={styles.OpenOrderPopUp}
                                    source={I18nManager.isRTL ? require("../res/images/pop-bg1.png") : require("../res/images/pop-bg.png")}>
                                    <Text style={{
                                        fontWeight: 'bold',
                                        color: "white",
                                        ...
                                        fontSize: 8,
                                        marginTop: 12
                                    }}>{localeStrings.homeScreenStrings.openOrder} </Text>
                                </ImageBackground>
                            </TouchableOpacity> : null}
                        ...
                        <TouchableOpacity onPress={() =>
                            ...
                            {(this.state.isCheckIn) ? <ImageBackground style={styles.ImgBackgroundCheckin}
                                ...
                                <Text style={styles.TextImgCheckin}>{localeStrings.homeScreenStrings.orders}</Text>
                            </ImageBackground> : <ImageBackground style={styles.ImgBackground}
                                source={require("../res/images/orders-bg.png")}>
                    ...
                    <View style={{
                            ...
                            <TouchableOpacity
                                ...
                                <View
                                    ...
                                    {(this.state.image.base64Uri) ?
                                        ...
                                        : (this.state.image.uri) ? <Image style={{ width: 50, height: 50, borderRadius: 25, resizeMode: "cover" }}
                                ...
                                <TouchableOpacity onPress={() => {
                                    ...
                                    <View style={styles.ViewTextImg}>
                                        <View style={{ flexDirection: "row" }}>
                                            ...
                                            <Text
                                                style={styles.homeScreenSignInText}>{localeStrings.homeScreenStrings.signIn}</Text>
                        ...
                        <View style={styles.ViewOptions}>
                            <TouchableOpacity onPress={() => {
                                ...
                                <View style={styles.ViewTextImg}>
                                    <Text
                                        style={styles.TextModal}>{localeStrings.homeScreenStrings.ordersHistory}</Text>
                                    <Image style={styles.ImgArrow} source={require("../res/images/arrowRight.png")} />
                                </View>
                            </TouchableOpacity>
                        ...
                        <View style={styles.ViewOptions}>
                            <TouchableOpacity onPress={() => {
                                ...
                                <View style={styles.ViewTextImg}>
                                    <Text
                                        style={styles.TextModal}>{localeStrings.homeScreenStrings.shareWithFriend}</Text>
                                    <Image style={styles.ImgArrow} source={require("../res/images/arrowRight.png")} />
                                </View>
                            </TouchableOpacity>
                        ...
                        <View style={styles.modalSecondView}>
                            ...
                            <View style={styles.container}>
                                <TouchableOpacity style={styles.CenterText}
                                    onPress={() => this.setState({ IsLoggedinModalVisible: false })}>
                                ...
                                <TouchableOpacity style={styles.CenterText}
                                    onPress={() => {
                                        if (session.value !== "true") {
                                            this.setState({ IsLoggedinModalVisible: false }); this.goToLogin();
                                        } else {
                                            this.setState({ IsLoggedinModalVisible: false }); this.showCheckIn();
                                        }
                                    }}>
                        ...
                        <View style={{
                            ...
                            <View style={{
                                ...
                                <TouchableOpacity onPress={() => {
                                    ...
                                    AsyncStorage.getItem('savedBarName').then((savedBarName) => {
                                        if (savedBarName != '') {
                                    ...
                                    AsyncStorage.getItem('tableNumber').then((tableNumber) => {
                                        if (tableNumber != '') {
                                    ...
                                    this.handleNavigation("MenuSlider", {
                                        screen: "MenuSlider",
                                        barId: GlobalVariables.restId.value ? GlobalVariables.restId.value : this.state.savedBarId,
                                        nameBar: GlobalVariables.restName.value ? GlobalVariables.restName.value : this.state.savedBarName,
                                        tableNumber: GlobalVariables.tableNumber.value ? GlobalVariables.tableNumber.value : this.state.tableNumber,
                                        showWelcome: true
                                    })
                                }} style={{

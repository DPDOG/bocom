...
import {
    ...
    Image,
    ScrollView,
    Alert, Dimensions, I18nManager, AsyncStorage
} from "react-native";
...
export default class Payment extends React.Component {
    ...
    constructor(props) {
        ...
        AsyncStorage.getItem('BuyerCardMask').then((value) => {
            ...
            fetch(GlobalVariables._URL + "/Isracard/Cards/" + this.params.User, {
                ...
                .then(response => {
                    if (response !== "") {
                        ...
                        this.setState({ SavedCards: GlobalVariables.cards });
                    } else {
                        this.setState({
                            isCard: false
                        })
    ...
    SendRequest(userId, requestData, type, remember) {
        ...
        try {
            fetch(GlobalVariables._URL + "/customers/" + userId + "/add-cart-items", {
                    ...
                    if (response !== "") {
                        ...
                        if (this.state.isPayPalSelected) {
                            ...
                            this.props.navigation.navigate("Isracard", {
                                ...
                                tips: totalTip,
                                coupon: this.params.coupon,
                                item1: this.state.cardMask,
                                item2: this.state.buyerExp,
                                item3: this.state.buyerName
                            })
                        }
                        // }
                    }
                ...
                <ScrollView>
                    <View style={{ flex: 1 }}>
                            ...
                            this.state.isCard ?
                                <View>
                                    <Text style={{
                                        ...
                                        marginTop: 5,
                                        textAlign: "center"
                                    }}>{localeStrings.paymentStrings.useAgain}</Text>
                                    {
                                        GlobalVariables.cards.map((items, index) =>
                                            <View key={index} style={{ marginHorizontal: 8 }}>
                                                ...
                                                <View style={this.state.savedCard && this.state.cardSelected == items.cardMask ? styles.selected : styles.unselected}>
                                                    <View style={{
                                                        flex: 1,
                                                        flexDirection: "row",
                                                        height: 60,
                                                        ...
                                                        <TouchableOpacity style={{
                                                            ...
                                                            onPress={() => {
                                                                this.UpdateRadioButtons(items.cardMask);
                                                            }}
                                                        ...
                                                        >
                                                            ...
                                                            <Image
                                                                ...
                                                                resizeMode="contain"
                                                                source={
                                                                    this.state.savedCard && this.state.cardSelected == items.cardMask
                                                                        ? selectedRadioButton
                                                                        : unselectedRadioButton
                                                                }
                                                            />
                                                        </TouchableOpacity>
                                                        <View style={{ flexDirection: "column", justifyContent: "center", width: "44%" }}>
                                                            <Text style={{ fontFamily: "Helvetica", fontSize: 15 }}>{localeStrings.paymentStrings.israCard}*</Text>
                                                            <Text style={{ fontFamily: "Helvetica", fontSize: 11, color: "#9B9B9B" }}>{localeStrings.paymentStrings.transactionFee}</Text>
                                                        </View>
                                                        <View style={{ flexDirection: "row", justifyContent: "flex-start" }}>
                                                            <Text style={{
                                                                ...
                                                                marginTop: 18,
                                                                marginRight: 5
                                                            }}>{items.cardMask.replace(/.(?=.{4})/g, '*')}</Text>
                                                            <Image
                                                ...
                                                <View style={{ flexDirection: "row", justifyContent: "flex-end" }}>
                                                    ...
                                                    <TouchableOpacity style={{ flexDirection: "row" }} onPress={() => {
                                                        if (this.state.cardSelected) {
                                                            this.setState({ removeModalVisible: true, selectedBuyerKey: items.buyer_key, selectedBuyerCardMask: items.buyer_card_mask })
                                                        } else {
                                                            Alert.alert(
                                                        ...
                                                        <Text style={{ marginRight: 5 }}>{localeStrings.paymentStrings.forgetCard}</Text>
                                                        <Image
                                                ...
                                                {index + 1 != GlobalVariables.cards.length ?
                                                    <Text style={{
                                                        ...
                                                        marginTop: 5,
                                                        textAlign: "center"
                                                    }}>{localeStrings.paymentStrings.chooseAnother}</Text> : <Text style={{
                                                        marginLeft: 15,
                                                        fontSize: 13,
                                                        fontStyle: "italic",
                                                        marginTop: 5,
                                                        textAlign: "center"
                                                    }}>{localeStrings.paymentStrings.textOr}</Text>}
                                            </View>
                        ...
                        >
                            <View style={[styles.modalFirstView, { justifyContent: "center" }]}>
                                ...
                                <View style={[styles.modalSecondView, { width: "80%" }]}>
                                    ...
                                    <View style={[styles.modalCenterText, { marginHorizontal: 20 }]}>
                                        <Text style={{
                                            fontSize: 18,
                                            color: "gray",
                                            fontWeight: "bold"
                                    ...
                                    <View style={styles.container}>
                                        <TouchableOpacity style={styles.CenterText}
                                            onPress={() => this.setState({ removeModalVisible: false })}>
                                            <Text style={styles.textStyle}>{localeStrings.paymentStrings.textNo}</Text>
                                        </TouchableOpacity>
                                        <View
                                            style={{
                                                borderLeftWidth: 1,
                        ...
                        <View style={{ marginTop: 10, marginHorizontal: 8 }}>
                            ...
                            <View
                                style={
                                    this.state.isIsracardSelected ? styles.selected : styles.unselected
                                }
                            >
                                <View style={{
                                    flex: 1,
                            ...
                            >
                                <View style={{
                                    ...
                                    <View style={{
                                        ...
                                        <Text style={{ fontFamily: "Helvetica", fontSize: 15 }}>{localeStrings.paymentStrings.payPal}*</Text>
                                        <Text style={{ fontFamily: "Helvetica", fontSize: 12, color: "#9B9B9B" }}>{localeStrings.paymentStrings.transactionFee}</Text>
                                    </View>
                                    <Image
                                        style={styles.imageCard}
 ...
 */}
                            <Text style={{ fontFamily: "Helvetica", fontSize: 17, fontWeight: "bold", marginTop: 25, textAlign: 'left' }}>{localeStrings.paymentStrings.waitressTip}</Text>
                            <View style={{
                                flexDirection: "row",
                                height: 45,
                                width: "100%",
                                ...
                                >
                                    ...
                                    /><Text style={{ fontFamily: "Helvetica", fontSize: 13, marginLeft: 8 }}>10%</Text>
                                </TouchableOpacity>
                                ...
                                >
                                    ...
                                    /><Text style={{ fontFamily: "Helvetica", fontSize: 13, marginLeft: 8 }}>15%</Text>
                                </TouchableOpacity>
                                <View style={{
                                    justifyContent: "center",
                                    alignItems: "center",
                                    ...
                                    <Text style={{ fontFamily: "Helvetica", fontSize: 12, color: "#9B9B9B" }}>{localeStrings.paymentStrings.textOr}</Text>
                                </View>
                                <View style={{
                                    borderColor: "#9B9B9B",
                                    borderWidth: 0.5,
                                ...
                                <View
                                    ...
                                    {this.state.totalTip !== 0 ? (GlobalVariables.userLanguage.value === "he-IL" ? <Text> {this.state.totalTip} =</Text> : <Text>= {this.state.totalTip}</Text>) : null}
                                ...
                                <View style={styles.modalCenterText}>
                                    ...
                                    {GlobalVariables.orders.map((items, index) => (
                                        <View key={index} style={{
                                            ...
                                            <View style={{ flexDirection: "row", width: "100%", justifyContent: "center", marginBottom: 10, flex: 1 }}>
                                                ...
                                                <View style={{
                                                    ...
                                                    <View style={{
                                                        ...
                                                        <View style={{
                                                            ...
                                                            {I18nManager.isRTL ? <Text style={{
                                                                ...
                                                                //  textAlign: "left",
                                                                marginRight: 15
                                                            }}>₪ {items.quantity * items.price}</Text> : <Text style={{
                                                                color: "black",
                                                                // textAlign: "left",
                                                                marginRight: 15
                                                            }}>{items.quantity * items.price} {GlobalVariables.restCurrencyCode.value}</Text>}
                                                    ...
                                                    <View style={{ flexDirection: "row", width: "100%", justifyContent: "flex-start", marginTop: -30, }}>
                                                        <View style={{
                                                            flexDirection: "row",
                                                            justifyContent: "flex-start",
                                                            alignItems: "center", textAlign: "left",
                                                        }}>
                                                            <Text numberOfLines={1}>{items.specialInstructions}</Text>
                                                        </View>
                                    ...
                                    <View style={{ flexDirection: "row" }}>
                                        <View style={{ flexDirection: "row", width: "50%", marginBottom: 50, justifyContent: "flex-start" }}>
                                            <View style={{
                                                flexDirection: "column",
                                                marginLeft: 15,
                                            }}>
                                        ...
                                        <View style={{ flexDirection: "row", width: "50%", marginBottom: 50, justifyContent: "flex-end" }}>
                                            <View style={{
                                                flexDirection: "column",
                                                marginRight: 35,
                                            }}>
                                                ...
                                                {I18nManager.isRTL ?
                                                    <Text style={{
                                                        ...
                                                        fontSize: 15,
                                                        marginTop: 8,
                                                    }}> ₪ {this.state.totalTip}</Text> : <Text style={{
                                                        fontFamily: "Helvetica",
                                                        fontSize: 15,
                                                        marginTop: 8,
                                                    }}> {this.state.totalTip} {GlobalVariables.restCurrencyCode.value}</Text>}
                                                ...
                                                {I18nManager.isRTL ?
                                                    <Text style={{
                                                        ...
                                                        fontSize: 15,
                                                        marginTop: 8,
                                                    }}> ₪ {this.state.discountAmount}</Text> : <Text style={{
                                                        fontFamily: "Helvetica",
                                                        fontSize: 15,
                                                        marginTop: 8,
                                                    }}> {this.state.discountAmount} {GlobalVariables.restCurrencyCode.value}</Text>}
                                                ...
                                                {I18nManager.isRTL ?
                                                    <Text style={{
                                                        ...
                                                        fontSize: 15,
                                                        marginTop: 8,
                                                    }}> ₪ {this.state.sum}</Text> : <Text style={{
                                                        fontFamily: "Helvetica",
                                                        fontSize: 15,
                                                        marginTop: 8,
                                                    }}> {this.state.sum} {GlobalVariables.restCurrencyCode.value}</Text>}
                                            </View>
                                        </View>
                                    </View>
                                    <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between', height: 60, marginTop: -30 }}>
                                        <View style={{ flexDirection: "row", width: "40%", marginLeft: 30, justifyContent: "flex-start" }}>
                                            <Button
                                                title={localeStrings.ordersStrings.goBack}
                                                type="outline"
                                                titleStyle={{ color: 'white' }}
                                                buttonStyle={{ justifyContent: "flex-start", backgroundColor: '#386aa6' }}
                                                onPress={() => {
                                                    this.hideModal();
                                                }}
                                            />
                                        </View>
                                        <View style={{ flexDirection: "row", width: "40%", marginRight: 30, justifyContent: "flex-end" }}>
                                            <Button
                                                title={localeStrings.ordersStrings.proceedBtn}
                                                type="outline"
                                                titleStyle={{ color: 'white' }}
                                                buttonStyle={{ justifyContent: "center", backgroundColor: '#386aa6' }}
                                                onPress={() => {
                                                    this.hideModal();
                                                    if (this.state.paymentMethod === "SaveCard") {
                                                        this.SendRequest(this.params.User, this.params.orderFull, this.state.paymentMethod, "1")
                                                    } else {
                                                        Alert.alert(
                                                            localeStrings.paymentStrings.alertHeading,
                                                            localeStrings.paymentStrings.alertText + " " + this.state.paymentMethod + "?",
                                                            [
                                                                {
                                                                    text: localeStrings.paymentStrings.textYes,
                                                                    onPress: () => {
                                                                        ...
                                                                        this.SendRequest(this.params.User, this.params.orderFull, this.state.paymentMethod, this.state.remember)
                                                                    }
                ...
                <View style={{
                    ...
                    <TouchableOpacity style={{ alignSelf: "center", justifyContent: "center", height: 65, width: "100%" }}
                        onPress={() => {
                            if (this.state.isPayPalSelected || this.state.isIsracardSelected || this.state.savedCard) {
                                this.showModal();
                            } else {
                                Alert.alert(
                                    localeStrings.paymentStrings.alertHeading,

...
import {
    ...
    TouchableOpacity,
    View,
    Image, I18nManager, AsyncStorage,
        ...
        return (
            <View style={{width: "100%", height: "100%"}}>
                ...
                <View style={{justifyContent: "center", alignItems: "center", marginTop: 20}}>
                    <Text style={PageStyles.textUp}>{localeStrings.orderCompletedStrings.thankYou}</Text>
                    <Text style={[PageStyles.textStyle, {marginTop: 10}]}>{localeStrings.orderCompletedStrings.youJustConfirmed}</Text>
                    <Text style={PageStyles.textStyle}>{localeStrings.orderCompletedStrings.ourStaff}</Text>
                </View>

                <View style={{justifyContent: "center", alignItems: "center", marginTop: 45}}>
                    <Image style={{resizeMode: "contain", width: 110, height: 120,transform: [{scaleX: I18nManager.isRTL ? 1 : 1}]}}
                           source={require('../../res/images/confirmed.png')}/>
                    <Text style={{fontFamily: "Helvetica", fontSize: 21, color: "#2CA970"}}>{localeStrings.orderCompletedStrings.orderNumber}{this.params.NoOrder}</Text>
                    <Text style={{fontFamily: "Helvetica", fontSize: 21, color: "#2CA970"}}>{localeStrings.orderCompletedStrings.completed}</Text>
                </View>

                <View style={{justifyContent: "center", alignItems: "center", marginTop: 20}}>
                    <Text style={PageStyles.textStyle}>{localeStrings.orderCompletedStrings.whenHeArrives}</Text>
                    <Text style={PageStyles.textStyle}>{localeStrings.orderCompletedStrings.pleaseOpen} </Text>
                    <Text style={PageStyles.textStyle}>{localeStrings.orderCompletedStrings.soHeWill}</Text>
                </View>

...
const localeStrings = new LocalizedStrings({
        ...
        en: {
            ...
            homeScreenStrings: {
                ...
                selectLanguage:"Select the language you want to change",
                english:"English",
                hebrew:"עברית",
                chat: "Chat",
                myWallet: "My Wallet",
                ...
                shareMessageLoggeedIn : " invites you to join the Bob family and start socializing with your friends and others.",
                shareMessage : " Here's an invite to join the Bob family and start socializing with your friends and others.",
            ...
            detailItemsStrings: {
                ...
                choiceOfDressing: "Choice of Dressing",
            ...
            paymentStrings : {
                ...
                useAgain : "You previously used this credit card. Want to use again?",
        ...
        he: {
            ...
            firstPageStrings: {
                middleText1: "הכנס\י לאפליקציית BoB והתחל להזמין בכל מקום",
                middleText2: " עם BoB אתה תכיר חברים חדשים במקום הבילוי ",
                signUp: "הרש\מה",
                logIn : "התחברות",
                signIn: "כניסה",
            ...
            homeScreenStrings: {
                ...
                locations: "מקומות בילוי",
                checkIn: "סריקת ברקוד",
                orders: "ההזמנות שלי ",
                inOrderTo: "בכדי להיכנס עליך לבצע תחילה הרשמה \כניסת משתמש",
                logOut: "יציאה",
                logIn : "התחברות",
                coupons: "קופונים",
                ...
                selectLanguage:"בחר את השפה שברצונך לשנות",
                english:"English",
                hebrew:"עברית",
                ordersHistory: 'היסטוריית הזמנות',
                shareWithFriend: 'שתפו עם חבר',
                shareMessageLoggeedIn: " מזמינה אתכם להצטרף למשפחת בוב ולהתחיל להתרועע עם חבריך ואחרים.",
                shareMessage : "הנה הזמנה להצטרף למשפחת בוב ולהתחיל לעשות קשרים עם חבריך ואחרים.",
            ...
            bobLocationAllStrings: {
                searchFor: "סרוק מקומות בילוי : פאבים, חופי ים, מלונות ועוד",
            ...
            barLocationStrings: {
                ...
                menu: "תפריט",
                ohOh: "אוי לא..",
                toReview: "לתפריט מלא יש להתחבר למערכת BoB",
            ...
            detailItemsStrings: {
                instructions: "הוראות",
                extraDressing: "תוספת רוטב",
                choiceOfDressing: "סוג הרוטב",
            ...
            paymentStrings : {
                ...
                useAgain : "השתמשת בעבר בכרטיס אשראי זה. רוצה להשתמש שוב?",
                ...
                addNewCard : "הוסף אמצעי תשלום חדש",
                deleteMessage: "האם אתה בטוח שברצונך למחוק את הכרטיס?",
                textOr : "או",
